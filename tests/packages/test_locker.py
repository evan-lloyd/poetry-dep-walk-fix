...
def test_locker_dumps_groups_and_markers(
    ...
    packages = {
        get_package("A", "1.0"): SolverPackageInfo(0, {"main"}, {"main": AnyMarker()}),
        get_package("B", "1.0"): SolverPackageInfo(
            0, {"main"}, {"main": parse_marker('sys_platform == "win32"')}
        ),
        get_package("C", "1.0"): SolverPackageInfo(
            0, {"main", "dev"}, {"main": AnyMarker(), "dev": AnyMarker()}
        ),
        get_package("D", "1.0"): SolverPackageInfo(
            0,
            {"main", "dev"},
            {
        ...
        get_package("E", "1.0"): SolverPackageInfo(
            0,
            {"main", "dev"},
            {
                "main": parse_marker('sys_platform == "win32"'),
        ...
        get_package("F", "1.0"): SolverPackageInfo(
            0,
            {"main", "dev"},
            {
                "main": parse_marker('sys_platform == "win32"'),
...
groups = ["main", "dev"]
files = []
marker = {{main = "sys_platform == \\"win32\\"", dev = "sys_platform == \\"linux\\""}}
...
groups = ["main", "dev"]
files = []
marker = {{main = "sys_platform == \\"win32\\""}}
